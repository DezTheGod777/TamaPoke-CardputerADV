...
![TamaPoke Cardputer ADV v0.8.5.4](https://raw.githubusercontent.com/DezTheGod777/TamaPoke-CardputerADV/og-v0.8.5.4-rc/docs/tamapoke-cardputer-adv-v0.8.5.4.jpg)
...
> **Current development release:** v0.8.5.4 RC3. The release-candidate source is kept on `og-v0.8.5.4-rc` until hardware testing is complete, then it will be promoted to the stable OG firmware line.

## v0.8.5.4 RC3 highlights
...
- Compact **battery meter** in the upper-right with low-battery warning; it is hidden during terrarium/idle mode for a clean scene.
...
- **Terrarium idle mode** after 30 seconds on Home: menus, idle label and battery HUD disappear while the Pokémon continues animating in the habitat. Any key returns to normal Home; the configured screen timeout continues separately.
- Improved Home HUD showing food, joy, energy, hygiene, age, weight, bond and level at a glance.
- Richer PMD personality behavior using idle, walk, pose, nod, breathing, sit, hop, hurt and attack animations when available.
- Expanded meadow, beach, forest, volcano, mountain and snow scenery with day/night treatment and ambient details.
